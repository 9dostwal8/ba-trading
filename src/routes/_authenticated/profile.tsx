...
const L = {
  ...
  editProfile: { ar: "تعديل البيانات والأمان", ku: "دەستکاریکردنی زانیاری و ئاسایش", en: "Edit Profile & Security" },
  editHint: { ar: "الاسم، رقم الهاتف وتغيير كلمة المرور", ku: "ناو، ژمارەی مۆبایل و گۆڕینی وشەی نهێنی", en: "Name, Phone & Change Password" },
